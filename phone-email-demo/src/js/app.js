(function () {
  ...
  const products = [
    { name: 'Chicken Shawarma', price: '₦2,500', description: 'Spicy grilled chicken wrapped in warm bread.', image: IMG + 'chicken-shawarma.jpg', fallback: IMG + 'chicken-shawarma.svg', avatar: IMG + 'avatars/person1.jpg' },
    { name: 'Sneakers', price: '₦18,000', description: 'Stylish everyday sneakers with premium comfort.', image: IMG + 'sneakers.jpg', fallback: IMG + 'sneakers.svg', avatar: IMG + 'avatars/person2.jpg' },
    { name: 'Hoodie', price: '₦15,000', description: 'Soft cotton hoodie for a relaxed street-style look.', image: IMG + 'hoodie.jpg', fallback: IMG + 'hoodie.svg', avatar: IMG + 'avatars/person3.jpg' },
    { name: 'Wristwatch', price: '₦7,500', description: 'Classic watch with a clean, elegant finish.', image: IMG + 'wristwatch.jpg', fallback: IMG + 'wristwatch.svg', avatar: IMG + 'avatars/person4.jpg' },
    { name: 'Phone Case', price: '₦3,000', description: 'Durable case with a sleek modern design.', image: IMG + 'phone-case.jpg', fallback: IMG + 'phone-case.svg', avatar: IMG + 'avatars/person5.jpg' },
    { name: 'Bag', price: '₦12,000', description: 'Premium carry bag built for daily use and style.', image: IMG + 'bag.jpg', fallback: IMG + 'bag.svg', avatar: IMG + 'avatars/person6.jpg' },
    { name: 'Perfume', price: '₦10,000', description: 'Luxury fragrance with a long-lasting scent.', image: IMG + 'perfume.jpg', fallback: IMG + 'perfume.svg', avatar: IMG + 'avatars/person7.jpg' },
    { name: 'Cap', price: '₦5,000', description: 'Modern cap with a structured, comfortable fit.', image: IMG + 'cap.jpg', fallback: IMG + 'cap.svg', avatar: IMG + 'avatars/person8.jpg' }
  ];
