(function () {
  ...
  const products = [
    { name: 'Chicken Shawarma', price: '₦2,500', description: 'Spicy grilled chicken wrapped in warm bread.', image: IMG + 'chicken-shawarma.jpg', fallback: IMG + 'chicken-shawarma.svg' },
    { name: 'Sneakers', price: '₦18,000', description: 'Stylish everyday sneakers with premium comfort.', image: IMG + 'sneakers.jpg', fallback: IMG + 'sneakers.svg' },
    { name: 'Hoodie', price: '₦15,000', description: 'Soft cotton hoodie for a relaxed street-style look.', image: IMG + 'hoodie.jpg', fallback: IMG + 'hoodie.svg' },
    { name: 'Wristwatch', price: '₦7,500', description: 'Classic watch with a clean, elegant finish.', image: IMG + 'wristwatch.jpg', fallback: IMG + 'wristwatch.svg' },
    { name: 'Phone Case', price: '₦3,000', description: 'Durable case with a sleek modern design.', image: IMG + 'phone-case.jpg', fallback: IMG + 'phone-case.svg' },
    { name: 'Bag', price: '₦12,000', description: 'Premium carry bag built for daily use and style.', image: IMG + 'bag.jpg', fallback: IMG + 'bag.svg' },
    { name: 'Perfume', price: '₦10,000', description: 'Luxury fragrance with a long-lasting scent.', image: IMG + 'perfume.jpg', fallback: IMG + 'perfume.svg' },
    { name: 'Cap', price: '₦5,000', description: 'Modern cap with a structured, comfortable fit.', image: IMG + 'cap.jpg', fallback: IMG + 'cap.svg' }
  ];
  ...
  if (grid && tpl) {
    products.forEach(function (p) {
      ...
      if (desc) {
        desc.textContent = p.description || 'A polished product detail designed to convert customers quickly.';
      }
